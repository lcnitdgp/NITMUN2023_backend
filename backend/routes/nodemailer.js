...
router.post("/allotmentmail/:id", async (req,res)=>{
    try{
        ...
        const main = async() => {
            ...
            (+91 70639 67246)<br/><br/>Please mention NITMUN XII- ( your name ) - ( institution ) while sending it. <br/>Let us know when and to whom you have made the payment, via mail. Kindly <b>attach a screenshot</b> of the payment record to the email.<br/><br/>Regards,<br/>Navneet Berwal,<br/>Under Secretary General,<br/>NITMUN XI.<br/>Contact number - +91 85296 22552`, 
